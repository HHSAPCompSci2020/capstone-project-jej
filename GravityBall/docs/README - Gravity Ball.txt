...
What is the story[a]? You are a lost soul, and you are trying to get to the spirit world. In order to do this you must collect spirit orbs.
What are the rules? What is the goal? Use keys to change gravity, most likely WASD. Get to the finish area.
Who would want to use your program[b]? People who enjoy playing games.
...
Where will you need to click? You will need to click as a main way of GUI[c]
Will you have menus that need to be navigated? What will they look like? Yes, the main menu and the level selector, they will probably look like a grid with pressable buttons[d] 
...
* Levels with different layouts, most likely 8-10, get from the start to the spirit orb[e]
* GUI
   * The user can interact with a main menu, a level select screen, and a pause menu when inside a level.
   * The GUI should have some sense of cleanliness.[f]
* Obstacles
   * Normal Walls
   * Spikes
...
* Changing gravity changes background color (Red if gravity is left, Yellow if up, Green if right, Blue if down)[g]
...
* Additional Levels
   * More challenging techniques and level design.[h]
...
* List the group members and describe how each member contributed to the completion of the final program. [i]This could be classes written, art assets created, leadership/organizational skills exercises, or other tasks. Initially, this is how you plan on splitting the work.
* Credit:
   * Utilized AnimationDemoProcessing as a blueprint - Edward
   * Copied Main class from GridWorld / GameOfLife - Edward


[a]This seems like an innovative plot! As this is a game, and it doesn't really solve a "problem" per say, maybe in the introduction you could elaborate on your story a bit?
[b]Though this is a true statement, I don't know how much it sells your game, so maybe answering this question like your trying to convince people to play could be a good strategy?
[c]I think you can be more specific here: maybe directly tell us where to click instead of just saying the screen? for example: [help] button, [next] button, etc
[d]What kind of buttons will be in the main menu and what are their functions?
[e]How do the levels get harder each time?
[f]How do you plan on implementing this?
[g]above it says you can combine keys: what happens to the colors then? do they just mix?
[h]be more specific here: what exactly do you plan to implement with "more challenging techniques"
[i]Though it's really just temporary, assigning some roles may be a good way to start planning on who's doing what, with the added bonus of completing the readme!